...
import type { IEquipmentInformation } from '../../interface/t_05'
  ...
  return (
    <div className="flex flex-col space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <Item
          title="Sensor"
          value={equipment_information?.type_thermometer?.toString()}
        />
        <Item
          title="Numero de puntos"
          value={equipment_information?.no_points?.toString()}
        />
        <Item
          title="Numero de lecturas"
          value={equipment_information?.no_readings?.toString()}
        />
      </div>
