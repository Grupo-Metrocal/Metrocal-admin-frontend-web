      ...
      <div className="instrument-zero-check grid grid-row-1 p-4 gap-2 bg-gray-100 rounded-lg">
        ...
        <div className="grid grid-cols-2">
          <div className="col-span-1">
            <Item
              title="Valor Nominal"
              value={String(instrument_zero_check.nominal_value)}
            />
          </div>
          <div className="col-span-1 flex">
            <Item title="X1" value={String(instrument_zero_check.x1)} />
            <Item title="X2" value={String(instrument_zero_check.x2)} />
