...
import { IEnvironmentalConditions } from '../../interface/v_01'
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border px-4 py-2 text-center">
                    ...
                    {point.presion_pa.initial}

                  </td>
                  <td className="border px-4 py-2 text-center">

                    {point.presion_pa.final}

                  </td>
                  <td className="border px-4 py-2 text-center">

                    {point.presion_pa.resolution}
