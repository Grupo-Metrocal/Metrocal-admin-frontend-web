...
export const LinearityTest = ({
  ...
  const [data, setData] = useState(linearityTest);


const handleInputChange = (newValue: number | string |string[], field: string, index: number) => {
  ...
  return (
    <div className="flex flex-col space-y-4">
            ...
            <tr key={index} className="text-center">
              <td className="border px-4 py-2">
                <input
                  ...
                  type="text"
                  value={test.point}
                  onChange={(e) => handleInputChange(e.target.value, 'point', index)}
                />
              </td>
              <td className="border px-4 py-2">
                <input
                  ...
                  onChange={(e) => handleInputChange(e.target.value.split(', '), 'pointsComposition', index)}
                />
              </td>
              <td className="border px-4 py-2">
                <input
                  ...
                  onChange={(e) => handleInputChange(e.target.value, 'indicationIL', index)}
                />
              </td>
              <td className="border px-4 py-2">
                <input
                  ...
                  onChange={(e) => handleInputChange(e.target.value, 'noLoadInfdication', index)}
                />
              </td>
            </tr>
          ))}
      ...
      <button onClick={handleAddRow} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4">
        Agregar Fila
      </button>
      <AlertDialogModal
